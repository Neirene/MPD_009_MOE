...
e.$prevArrow.removeClass("slick-disabled").attr("aria-disabled","false")):e.currentSlide>=e.slideCount-1&&e.options.centerMode===!0&&(e.$nextArrow.addClass("slick-disabled").attr("aria-disabled","true"),e.$prevArrow.removeClass("slick-disabled").attr("aria-disabled","false")))},e.prototype.updateDots=function(){var t=this;null!==t.$dots&&(t.$dots.find("li").removeClass("slick-active").attr("aria-hidden","true"),t.$dots.find("li").eq(Math.floor(t.currentSlide/t.options.slidesToScroll)).addClass("slick-active").attr("aria-hidden","false"))},e.prototype.visibility=function(){var t=this;t.options.autoplay&&(document[t.hidden]?t.interrupted=!0:t.interrupted=!1)},t.fn.slick=function(){var t,i,o=this,s=arguments[0],n=Array.prototype.slice.call(arguments,1),r=o.length;for(t=0;r>t;t++)if("object"==typeof s||"undefined"==typeof s?o[t].slick=new e(o[t],s):i=o[t].slick[s].apply(o[t].slick,n),"undefined"!=typeof i)return i;return o}}),function(t){"use strict";t.fn.fitVids=function(e){var i={customSelector:null,ignore:null};if(!document.getElementById("fit-vids-style")){var o=document.head||document.getElementsByTagName("head")[0],s=".fluid-width-video-wrapper{width:100%;position:relative;padding:0;}.fluid-width-video-wrapper iframe,.fluid-width-video-wrapper object,.fluid-width-video-wrapper embed {position:absolute;top:0;left:0;width:100%;height:100%;}",n=document.createElement("div");n.innerHTML='<p>x</p><style id="fit-vids-style">'+s+"</style>",o.appendChild(n.childNodes[1])}return e&&t.extend(i,e),this.each(function(){var e=['iframe[src*="player.vimeo.com"]','iframe[src*="youtube.com"]','iframe[src*="youtube-nocookie.com"]','iframe[src*="kickstarter.com"][src*="video.html"]',"object","embed"];i.customSelector&&e.push(i.customSelector);var o=".fitvidsignore";i.ignore&&(o=o+", "+i.ignore);var s=t(this).find(e.join(","));s=s.not("object object"),s=s.not(o),s.each(function(){var e=t(this);if(!(e.parents(o).length>0||"embed"===this.tagName.toLowerCase()&&e.parent("object").length||e.parent(".fluid-width-video-wrapper").length)){e.css("height")||e.css("width")||!isNaN(e.attr("height"))&&!isNaN(e.attr("width"))||(e.attr("height",9),e.attr("width",16));var i="object"===this.tagName.toLowerCase()||e.attr("height")&&!isNaN(parseInt(e.attr("height"),10))?parseInt(e.attr("height"),10):e.height(),s=isNaN(parseInt(e.attr("width"),10))?e.width():parseInt(e.attr("width"),10),n=i/s;if(!e.attr("name")){var r="fitvid"+t.fn.fitVids._count;e.attr("name",r),t.fn.fitVids._count++}e.wrap('<div class="fluid-width-video-wrapper"></div>').parent(".fluid-width-video-wrapper").css("padding-top",100*n+"%"),e.removeAttr("height").removeAttr("width")}})})},t.fn.fitVids._count=0}(window.jQuery||window.Zepto),function(t,e){"use strict";var i=t(document);i.ready(function(){if("/landing/"!=window.location.pathname){console.log("the last saved sessionstorage value is: "+sessionStorage.getItem("introSkip"));var e=t(".post-content");e.fitVids(),t(".scroll-down").arctic_scroll(),t(".menu-button, .nav-cover, .nav-close").on("click",function(e){e.preventDefault(),t("body").toggleClass("nav-opened nav-closed")});for(var i=0;i<t("article h2 a").length;i++){var o=t('article h2 a:eq("'+i+'")').attr("href");null!=o.match("-lg")?t('article:eq("'+i+'")').addClass("grid-element-lg"):null!=o.match("-md")?t('article:eq("'+i+'")').addClass("grid-element-md"):null!=o.match("-sm")?t('article:eq("'+i+'")').addClass("grid-element-sm"):console.log("OUT OF LUCK!")}}}),t.fn.arctic_scroll=function(e){var i={elem:t(this),speed:500},o=t.extend(i,e);o.elem.click(function(e){e.preventDefault();var i,s=t(this),n=t("html, body"),r=!!s.attr("data-offset")&&s.attr("data-offset"),a=!!s.attr("data-position")&&s.attr("data-position");r?(i=parseInt(r),n.stop(!0,!1).animate({scrollTop:t(this.hash).offset().top+i},o.speed)):a?(i=parseInt(a),n.stop(!0,!1).animate({scrollTop:i},o.speed)):n.stop(!0,!1).animate({scrollTop:t(this.hash).offset().top},o.speed)})}}(jQuery),$(window).load(function(){$(".loading-screen").addClass("section-loaded")}),$(document).ready(function(){function t(){var t=document.getElementById("landing-bg"),e=document.createElement("source");e.setAttribute("src","/assets/video/hispeed.webm"),e.setAttribute("type","video/webm"),t.appendChild(e),t.addEventListener("canplaythrough",function(){t.play(),$(".title-slice").addClass("opened-slices"),$(".video-container").addClass("display-video"),this.removeEventListener("canplaythrough",this,!1)})}"/landing/"==window.location.pathname&&("YES"==sessionStorage.getItem("introSkip")?window.location="/":(t(),$(document).on("click",".start-wrapper",function(t){t.preventDefault(),sessionStorage.setItem("introSkip","YES"),$(".loading-screen").removeClass("section-loaded"),window.location="/"})))});